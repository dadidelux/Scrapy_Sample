...
PARAMS = {
    ...
    "lang": "en-PH",
    "currency": "USD",
    "categoryId": "69175",  # SHOPBOP BEAUTY CATEGORY
    "facetAllowList": "C",
    "limit": 100,
    "includeFacets": "true",
...
print("⏳ Downloading beauty products from Shopbop...")
...
with open("shopbop_beauty_products.json", "w", encoding="utf-8") as f:
    json.dump(all_products, f, ensure_ascii=False, indent=2)

print(f"🎉 Done! Total beauty products downloaded: {len(all_products)}")
