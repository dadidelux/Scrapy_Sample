...
# Load JSON file
with open("alo/json/alo_yoga_mens_products.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
# Save to CSV
df.to_csv("alo/csv/alo_yoga_products_mens_processed.csv", index=False)

print("✅ Data processed and saved to 'alo_yoga_products_mens_processed.csv'")
