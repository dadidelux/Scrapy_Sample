...
url = 'https://jadedldn.com/en-ph/collections/all'
headers = {
...
with open("jadedldn_products_all.html", "w", encoding="utf-8") as html_file:
    html_file.write(html)
print("\n💾 Saved the HTML to jadedldn_products_all_poga.html")
...
if not os.path.exists("jadedldn_products_all.html"):
...
if js_obj_str:
    ...
    try:
        ...
        with open("jadedldn_collectionView_all.json", "w", encoding="utf-8") as out_f:
