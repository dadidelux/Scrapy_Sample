...
# Load JSON file
with open("shopbop/json/shopbop_beauty_products.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
df.to_csv("shopbop/csv/shopbop_beauty_products_full.csv", index=False, encoding="utf-8")

print("✅ CSV created: shopbop_beauty_products_full.csv")
