...
def fetch_page(offset=0, limit=15):
    variables = {
        "handle": "shoes",  # ← changed for shoes collection
        "offset": offset,
        "limit": limit,
        "sortKey": "DEFAULT",
        "filters": [],
...
# Save to JSON
with open("alo/json/alo_yoga_shoes_products.json", "w", encoding="utf-8") as f:
    json.dump(all_products, f, ensure_ascii=False, indent=2)

print(f"✅ Done. Saved {len(all_products)} shoes to alo_yoga_shoes_products.json")
